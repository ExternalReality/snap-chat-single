<div class="chatwindow loginwindow">
  ...
  <div class="form">
    <form action='login'>
      <fieldset>
        ...
        <input maxlength="40" name="password" class="password" type="hidden"/>
      </fieldset>
        <input type="submit" class="cupid-green" value="Join the chat room">
    </form>
  </div>
</div>
